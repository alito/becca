...
class Block(object):
    ...
    """
    def __init__(self, max_cables=3000, max_cogs=300,
        ...
        self.ziptie = ZipTie(self.max_cables, self.max_cogs, mean_exponent=1.,
                             joining_threshold=0.005, name=ziptie_name)
        self.cogs = []
